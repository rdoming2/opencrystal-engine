...
From a transition/door tile with a target map + target position, `f` follows to the target map
and prompts to save, discard, or cancel when unsaved edits exist before jumping.
