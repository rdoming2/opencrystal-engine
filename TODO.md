...
- [x] Show shop equipment compatibility (allowed jobs + current party applicability with color-coded upgrade indicators).
...
- [x] Add map-editor transition/door follow flow with save/discard jump options.
...
- [x] Migrate CLI parsing to clap and add clap_complete bash/zsh completion with path-aware flags.
